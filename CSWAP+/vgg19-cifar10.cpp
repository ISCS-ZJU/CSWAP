...
struct Net : torch::nn::Module {
    Net() {
        ...
        std::function<torch::Tensor(const torch::Tensor&)> functions[54] = {
        ...
        v = std::vector<std::function<torch::Tensor(const torch::Tensor&)>>(functions,functions+54);

        Layer_type types_[54] = {CONV,BN,ACT,CONV,BN,ACT,POOL,CONV,BN,ACT,CONV,BN,ACT,POOL,
        CONV,BN,ACT,CONV,BN,ACT,CONV,BN,ACT,CONV,BN,ACT,POOL,
        CONV,BN,ACT,CONV,BN,ACT,CONV,BN,ACT,CONV,BN,ACT,POOL,
        CONV,BN,ACT,CONV,BN,ACT,CONV,BN,ACT,CONV,BN,ACT,POOL,POOL};
        types = std::vector<Layer_type>(types_,types_+54);
        policy.resize(54,0);
...
int main(int argc,char* argv[]){
    ...
    int iter = 0;
    //net.policy[2] = 2,net.policy[6] = 2,net.policy[9] = 2,net.policy[13] = 2,
    //net.policy[16] = 2,net.policy[19] = 2
    //,net.policy[22] = 2,net.policy[26] = 2,net.policy[29] = 2,net.policy[32] = 2,
    //net.policy[35] = 2,net.policy[39] = 2,
    //net.policy[42]=2,net.policy[45]=2,net.policy[48]=2;
    ...
    //net.policy[35] = 3,net.policy[39] = 3,
    //net.policy[42]=3,net.policy[45]=3,net.policy[48]=3;
    ...
    //exe.policy[2] = 3,exe.policy[6] = 3,exe.policy[9] = 3,exe.policy[13] = 3,
    //exe.policy[16] = 3,exe.policy[19] = 3
    //,exe.policy[22] = 3,exe.policy[26] = 3,exe.policy[29] = 3,exe.policy[32] = 3,
    //exe.policy[35] = 3,exe.policy[39] = 3,
    //exe.policy[42]=3,exe.policy[45]=3,exe.policy[48]=3;

    //exe.policy[2] = 3,exe.policy[6] = 6,exe.policy[9] = 3,exe.policy[13] = 6,
    //exe.policy[16] = 3,exe.policy[19] = 3
    //,exe.policy[22] = 3,exe.policy[26] = 6,exe.policy[29] = 3,exe.policy[32] = 3,
    //exe.policy[35] = 3,exe.policy[39] = 6,
    //exe.policy[42]=3,exe.policy[45]=3,exe.policy[48]=3;
    ...
    //c10::GetCompressProfile()->to_txt("/nfs/home/schen/dcgan/build/compress2/2560/vgg19-cifar10_1.txt");
    //c10::GetCompressProfile()->to_txt4("/nfs/home/schen/dcgan/build/compress4/2560/vgg19-cifar10_.txt");

    if(c10::ProfilerSwitch::is_enabled()){
        c10::GetProfilerImpl()->to_txt("result/vgg19_cifar10_128.txt");
    }
